...
# Linetypes & Pointtypes

set style line 1 linecolor 2 linetype 3 linewidth 3 pointtype 20 pointsize 0.5
set style line 2 linecolor rgb 'red' linetype 3 linewidth 2 pointtype 15 pointsize 0.4
...
set y2label '{/:Bold Seccondary data}' offset -2.5,0,0 rotate by 270
